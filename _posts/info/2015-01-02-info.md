...
With the exception of our Week 3 (July 5-8), when our XPs run until 4pm, the XP projects also last from 9am to 3pm, so the day length is the same as for the other CAMPers. 
